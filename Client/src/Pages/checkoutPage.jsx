...
const checkoutPage = () => {
    ...
    try {
      ...
      const cartItemsWithDetails = await Promise.all(
        data.cartItems.map(async (item) => {
          ...
          total += productDetails.price * item.qty; 
          return {
            ...item,
            id: item._id,
            ...productDetails,
  ...
  return (
    <>
      <Navbar />
        <div class="pt-20 md:pt-28 grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-48">
          <div class="px-4 pt-8">
            ...
            {cartItems.map((product) => (
              ...
              <div class="flex flex-col rounded-lg bg-white sm:flex-row">
                ...
                <div class="flex w-full flex-col px-4 py-4">
                  ...
                  <span class="float-right text-sm text-gray-600">Qty: {product.qty}</span>
                  <p class="text-base font-medium">Rs.{product.price}</p>
                </div>
              </div>
            ))}
            ...
            <div class="">
              ...
              <div class="mt-6 border-t border-b py-2">
                <div class="flex items-center justify-between">
                  ...
                  <p class="font-semibold text-gray-900">Rs.{totalCost}</p>
                </div>
                <div class="flex items-center justify-between">
                  <p class="text-sm font-medium text-gray-900">Shipping</p>
                  <p class="font-semibold text-gray-900">Rs.50</p>
                </div>
              </div>
              <div class="mt-6 flex items-center justify-between">
                <p class="text-sm font-medium text-gray-900">Total</p>
                <p class="text-2xl font-semibold text-gray-900">Rs.{totalCost+50}</p>
              </div>
            </div>
